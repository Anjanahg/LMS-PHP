...
$product = "SELECT * FROM product WHERE type ='friction' AND reserve ='no'";
    ...
    <div class="container text-center text-md-left">
        <div class="row">
            <div class="col-md-3 mx-auto">
                <h5 class="font-weight-bold text-uppercase mt-3 mb-4">Books Vareities</h5>
            ...
            <div class="col-md-3 mx-auto">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a href="./menu.html">Signature Books</a>
                    </li>
                    <li>
                        <a href="./Customize.html">Customize your Books</a>
                    </li>
                </ul>
            </div>
            <hr class="clearfix w-100 d-md-none">
